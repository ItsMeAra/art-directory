  ...
  return (
    ...
    `}>
      <div className="flex items-start justify-between gap-2">
        ...
        {listing.location && (
          <span className="text-xs text-gray-400 shrink-0 pt-0.5">{listing.location}</span>
        )}
      </div>

      <div>
        <h2 className="font-semibold text-gray-900 text-base leading-snug">{listing.name}</h2>
      ...
      <a
        ...
        className="mt-auto inline-flex items-center justify-center gap-1.5 px-4 py-2 rounded-lg bg-gray-900 text-white text-sm font-medium hover:bg-gray-700 transition-colors"
      >
        Visit
